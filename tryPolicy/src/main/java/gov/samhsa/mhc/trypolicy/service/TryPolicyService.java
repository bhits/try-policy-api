...
import gov.samhsa.mhc.trypolicy.service.dto.DSSResponse;
import gov.samhsa.mhc.trypolicy.service.exception.TryPolicyException;

public interface TryPolicyService {

    DSSResponse getSegmentDocResponse(String patientUsername, String patientId, String documentId, String consentId, String purposeOfUseCode) throws TryPolicyException;
